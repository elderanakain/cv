...
\begin{minipage}[t]{0.6\textwidth}
    ...
    \begin{subsec}{\kiwiUrl{Kiwi.com}}{07.2018 – Present}
        \> \kiwiAppUrl{Kiwi.com Android app}, booking main developer. \lineend
    ...
    \begin{subsec}{\crunchyrollUrl{Crunchyroll}}{01.2017 – 08.2017}
        \> \vrvAppUrl{VRV} and \crunchyrollAppUrl{Crunchyroll} Android apps development. \lineend
        \> Tech stack: Java/Kotlin, Retrofit2+OkHttp3, \\
        \> Chromecast, MVP, Fabric, Exoplayer, Firebase, \\
        \> Branch.io, Outbound.io, JUnit4, Mockito1. \\
    \end{subsec}
    
    \vspace{24pt}
    
    \begin{subsec}{\yopesoUrl{Yopeso}}{08.2016 – 01.2017}
        \> \limangoAppUrl{limango} Android app development. \lineend
    ...
    \begin{subsec}{\travodUrl{Travod}}{10.2015 – 08.2016}
        \> Technical support, DTP and project management. \lineend
    ...
    \begin{subsec}{\aursoftUrl{Aursoft}}{02.2015 – 12.2015}
        \> MyBebe Android app development. \lineend
    ...
    \begin{subsec}{\muniUrl{Masaryk University}}{2017 – 2019}
        \> MSc, \muniFiUrl{Faculty of Informatics} \\
    ...
    \begin{subsec}{\usmUrl{State University of Moldova}}{2014 – 2017}
        \> BSc, \fmiUsmUrl{Mathematics and Computer Science} \\
